...
export default function RecentMonitors() {
  // last 5 monitors
  const lastFiveMonitors = monitorsData.slice(-5);
          ...
          <tbody className="bg-zinc-800 text-gray-300">
            {lastFiveMonitors.map((itm) => (
              ...
              >
                ...
                <td className="p-3 text-blue-400 cursor-not-allowed">
                  {itm.url}
                </td>
                <td
